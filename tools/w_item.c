...
int pr_w_item(void *row)
{
	...
	if (SCHEMA_W < 1)
	{
		...
		print_json_schema_start(ITEM);
		print_json_schema_col(ITEM, "I_ITEM_SK", "STRING");
		print_json_schema_col(ITEM, "I_ITEM_ID", "STRING");
		print_json_schema_col(ITEM, "I_REC_START_DATE", "DATE");
		print_json_schema_col(ITEM, "I_REC_END_DATE", "DATE");
		...
		print_json_schema_col(ITEM, "I_CLASS", "STRING");
		print_json_schema_col(ITEM, "I_CATEGORY_ID", "INT");
		print_json_schema_col(ITEM, "I_CATEGORY", "STRING");
		print_json_schema_col(ITEM, "I_MANUFACT_ID", "INT");
		print_json_schema_col(ITEM, "I_MANUFACT", "STRING");
		print_json_schema_col(ITEM, "I_SIZE", "STRING");
		print_json_schema_col(ITEM, "I_FORMULATION", "STRING");
		print_json_schema_col(ITEM, "I_COLOR", "STRING");
		print_json_schema_col(ITEM, "I_UNITS", "STRING");
		print_json_schema_col(ITEM, "I_CONTAINER", "STRING");
		print_json_schema_col(ITEM, "I_MANAGER_ID", "INT");
		print_json_schema_end(ITEM, "I_PRODUCT_NAME", "STRING");
	}
	SCHEMA_W = 1;
