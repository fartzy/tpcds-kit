...
int pr_w_date(void *row)
{
	...
	if (SCHEMA_W < 1)
	{
		...
		print_json_schema_col(DATE, "D_YEAR", "INT");
		print_json_schema_col(DATE, "D_DOW", "INT");
		print_json_schema_col(DATE, "D_MOY", "INT");
		print_json_schema_col(DATE, "D_DOM", "INT");
		print_json_schema_col(DATE, "D_QOY", "INT");
		print_json_schema_col(DATE, "D_FY_YEAR", "INT");
		print_json_schema_col(DATE, "D_FY_QUARTER_SEQ", "INT");
		print_json_schema_col(DATE, "D_FY_WEEK_SEQ", "INT");
		print_json_schema_col(DATE, "D_DAY_NAME", "STRING");

		print_json_schema_col(DATE, "D_QUARTER_NAME", "STRING");
		print_json_schema_col(DATE, "D_HOLIDAY", "STRING");
		print_json_schema_col(DATE, "D_WEEKEND", "STRING");
		print_json_schema_col(DATE, "D_FOLLOWING_HOLIDAY", "STRING");
		print_json_schema_col(DATE, "D_FIRST_DOM", "INT");
		...
		print_json_schema_col(DATE, "D_CURRENT_QUARTER", "STRING");
		print_json_schema_end(DATE, "D_CURRENT_YEAR", "STRING");
	}
	SCHEMA_W = 1;
